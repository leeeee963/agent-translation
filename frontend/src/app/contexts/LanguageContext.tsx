...
const translations: Record<string, Record<AppLanguage, string>> = {
  ...
  'glossary.contextPlaceholder': { en: 'Add context...', zh: '添加领域含义...' },
  ...
  'library.termContext': { en: 'Context', zh: '领域含义' },
  'library.domainName': { en: 'Domain Name', zh: '域名称' },
  'library.confirmDeleteDomain': { en: 'Delete this domain and all its terms?', zh: '确定删除此领域及其所有术语？' },
  'library.confirmBatchDelete': { en: 'Delete {count} selected terms?', zh: '确定删除选中的 {count} 个术语？' },
  'library.noDomains': { en: 'No domains yet. Click "New" to create one.', zh: '暂无领域，点击"新建"创建' },
  'library.termCount': { en: '{count} terms', zh: '{count} 个术语' },
  'library.langColumns': { en: 'Languages', zh: '语言列' },
  'library.showLangColumns': { en: 'Show language columns', zh: '显示语言列' },
  'library.termUsage': { en: 'Usage', zh: '使用' },
  'library.noMatchingTerms': { en: 'No matching terms', zh: '没有匹配的术语' },
  'library.pagination': { en: '{total} terms, page {page}/{pages}', zh: '共 {total} 个术语，第 {page}/{pages} 页' },
  'library.domainNamePlaceholder': { en: 'e.g., AI/ML, Legal, Medical', zh: '例如：AI/ML、法律、医疗' },
  'library.domainDescOptional': { en: 'Description (optional)', zh: '描述（可选）' },
  'library.domainDescPlaceholder': { en: 'Brief description of this domain', zh: '简要描述此领域' },
  'common.selectAll': { en: 'Select all', zh: '全选' },
  'common.prevPage': { en: 'Previous', zh: '上一页' },
  'common.nextPage': { en: 'Next', zh: '下一页' },
  'library.importStepFileDesc': { en: 'Upload a CSV or TSV file with language codes as column headers.', zh: '上传 CSV 或 TSV 文件，使用语言代码作为列名。' },
  'library.importOptionalCols': { en: 'Optional columns: strategy (hard = enforce, keep_original = preserve, skip = free; defaults to hard), context.', zh: '可选列：strategy（hard=约束、keep_original=保留、skip=自由，不填默认 hard）、context。' },
  'library.importTemplate': { en: 'Download CSV template', zh: '下载 CSV 模板' },
  'library.importDragDrop': { en: 'Drag & drop file here, or click to browse', zh: '拖拽文件到此处，或点击选择文件' },
  'library.importFileSelected': { en: 'Selected: {name}', zh: '已选择：{name}' },
  'library.importChangeFile': { en: 'Change file', zh: '重新选择' },
  'library.importSuccess': { en: 'Import complete: {inserted} added, {updated} updated.', zh: '导入完成：新增 {inserted} 个，更新 {updated} 个。' },
  'library.importSkipped': { en: '{skipped} rows skipped.', zh: '跳过 {skipped} 行。' },
  'library.importAgain': { en: 'Import another file', zh: '继续导入' },
  'library.importFormatExample': { en: 'Example: en, zh-CN, ja, ko, strategy, context', zh: '示例：en, zh-CN, ja, ko, strategy, context' },
